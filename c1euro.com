...
@media (max-width: 1024px) {
  ...
  function openPopup() {
    ...
    // Tracking de la vue popup
    if (typeof window.umami === 'function') {
      umami('popup-view');
    }
  }

  // Clic sur le bouton "Lancer l'app"
