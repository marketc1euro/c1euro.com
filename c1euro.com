...
@media (max-width: 1024px) {
  ...
  // Fonction : charger et lancer lottie
  ...
  // Affichage conditionnel du popup + tracking + Lottie
  (function () {
    ...
    function openPopup() {
      ...
      if (typeof window.lottie === 'object') {
        loadLottieAnimation();
      }
    }
