...
@media (max-width: 1024px) {
  ...
  window.addEventListener('load', function() {
    ...
    if (titre && titre.textContent.trim() === "Tags") {
        ...
        loop: false,
        autoplay: false,
        path: '/media/files/isomet.json' // Ton nouveau fichier
      });
