...
@media (max-width: 1024px) {
  ...
  window.addEventListener('load', function() {
    ...
    if (titre && titre.textContent.trim() === "Tags") {
        ...
        loop: false,
        autoplay: false,
        path: '/media/files/area.json' // Ton nouveau fichier
      });
  ...
  // Umami tracking : bouton clic avec délai avant redirection
  document.getElementById('launch-app-btn').addEventListener('click', function (e) {
    ...
    // Donne le temps au tracking d'être envoyé avant de rediriger
    setTimeout(() => {
