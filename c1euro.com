...
<!-- ⛔️ Supprime les <link rel="stylesheet"> bloquants du <head> -->

<!-- ✅ CSS critique inline : à adapter -->
<style>
  /* Ici tu mets le minimum : typographie, layout général, header, etc. */
  body {
...
<!-- ✅ JS : charger le CSS après le rendu -->
<script>
  window.addEventListener("load", function () {
    const styles = [
      "/css/style.css?v=988e814",
      document.querySelector('.pswp') ? "/coreLightboxGallery/photoswipe.min.css" : null
    ].filter(Boolean);
    styles.forEach(href => {
