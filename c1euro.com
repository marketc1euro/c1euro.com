...
<html lang="fr">
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
            <title>Error 404 - c1euro.com</title>
...
<link rel="alternate" type="application/json" href="https://c1euro.com/feed.json" title="c1euro.com - JSON">
        ...
        <meta property="og:title" content="c1euro.com"><meta property="og:image" content="https://c1euro.com/media/website/HOME2.webp"><meta property="og:image:width" content="2200"><meta property="og:image:height" content="1485"><meta property="og:site_name" content="c1euro.com"><meta property="og:description" content=""><meta property="og:url" content="https://c1euro.com/"><meta property="og:type" content="website">
        ...
        <script type="application/ld+json">{"@context":"http://schema.org","@type":"Organization","name":"c1euro.com","logo":"https://c1euro.com/media/website/LOGO67-2-2-2.svg","url":"https://c1euro.com/","sameAs":["https://www.facebook.com/profile.php?id=61554010615115","https://www.instagram.com/appc1euro/","https://fr.pinterest.com/c1euroapp/","https://www.youtube.com/@c1euro"]}</script>      
        <noscript>
            <style>
                img[loading] {
                    opacity: 1;
...
<script defer src="https://cloud.umami.is/script.js" data-website-id="edb4f2a1-5cdf-4ef3-b837-efe910763b4b"></script>
...
<script>
  document.addEventListener("DOMContentLoaded", () => {
    ...
    <body class="error-template">
        <!-- Cloudflare Web Analytics --><script defer src='https://static.cloudflareinsights.com/beacon.min.js' data-cf-beacon='{"token": "fa51fcb66a4a439b8df347aefc247af7"}'></script><!-- End Cloudflare Web Analytics -->
...
</div>   <main class="main page page--error">
      <div class="hero">
         <div class="main__inner">
             <h1>Explore, be curious.</h1>
...
<p>The page you were looking for appears to have been moved, deleted or does not exist. You could go back to where you were or head straight to our home page.</p>
         <p>
           <a href="https://c1euro.com/" class="btn">Go Home</a>
         </p>
      </div>
   </main>
   <div class="right-bar">
    ...
    <div style="display: flex; justify-content: center; width: 100%; margin-bottom: 25px;">
      <div style="display: flex; gap: 15px; overflow-x: auto; padding: 10px 0; max-width: 100%;">
        ...
        <div style="flex: 0 0 140px; background: #242528; border-radius: 8px; padding: 12px; text-align: center;">
          <img src="https://c1euro.com/media/posts/15/4cdecc1f11ba304d07d53eac145691a045585410-80x80_Z1T7HQb-2.svg" style="width: 80px; height: 80px; margin: 0 auto 8px;">
          <div style="background: #161718; color: #fff; border-radius: 999px; padding: 4px 12px; font-size: 0.85em;">Mode</div>
        </div>
        <div style="flex: 0 0 140px; background: #242528; border-radius: 8px; padding: 12px; text-align: center;">
          <img src="https://c1euro.com/media/posts/15/7c505ae37f53d46df50d526fc771b0084c867e64-80x80_16paFn-1.svg" style="width: 80px; height: 80px; margin: 0 auto 8px;">
          <div style="background: #161718; color: #fff; border-radius: 999px; padding: 4px 12px; font-size: 0.85em;">Alimentation</div>
        </div>
        <div style="flex: 0 0 140px; background: #242528; border-radius: 8px; padding: 12px; text-align: center;">
          <img src="https://c1euro.com/media/posts/15/700c06cf291d4a213547eb48733aea2422f06f87-80x80_ZNVBu0.svg" style="width: 80px; height: 80px; margin: 0 auto 8px;">
          <div style="background: #161718; color: #fff; border-radius: 999px; padding: 4px 12px; font-size: 0.85em;">High-tech</div>
        </div>
        <div style="flex: 0 0 140px; background: #242528; border-radius: 8px; padding: 12px; text-align: center;">
          <img src="https://c1euro.com/media/posts/15/b430f69d910f82bf07dca72bc21a49aa5887710c-80x80_Zhczk2-1.svg" style="width: 80px; height: 80px; margin: 0 auto 8px;">
          <div style="background: #161718; color: #fff; border-radius: 999px; padding: 4px 12px; font-size: 0.85em;">Livreur</div>
        </div>
      </div>
    </div>

    <div id="popup-desc" style="text-align: center; font-size: 1.2em; margin-bottom: 15px; font-family: 'Public Sans', sans-serif; color: #95a5a6;">
      Cliquez ci-dessous pour télécharger l'application C1EURO
    </div>
...
<script>
  ...
  function trackUmami(eventName) {
    const tryTrack = () => {
      if (typeof window.umami === 'function') {
        ...
        console.log('[UMAMI] Événement :', eventName);
      } else {
  ...
  function showPopup() {
    ...
    trackUmami('popup-view');
    if (window.lottieInstance) lottieInstance.play();
  }
  ...
  (function () {
    const FIRST_OPEN_KEY = 'popup_first_open';
    const SECOND_OPEN_KEY = 'popup_second_open';
    const LAST_OPEN_KEY = 'popup_last_open';

    const firstOpen = parseInt(localStorage.getItem(FIRST_OPEN_KEY)) || null;
    const secondOpen = parseInt(localStorage.getItem(SECOND_OPEN_KEY)) || null;
    const lastOpen = parseInt(localStorage.getItem(LAST_OPEN_KEY)) || null;

    // Enregistre la première visite si jamais pas enregistré
    if (!firstOpen) {
      localStorage.setItem(FIRST_OPEN_KEY, Date.now());
    }

    // Timer à déclencher 30 sec après un clic (entre 1ère et 2ème ouverture)
    let timerId = null;
    document.addEventListener('click', () => {
      if (firstOpen && !secondOpen && !timerId) {
        timerId = setTimeout(() => {
          showPopup();
          localStorage.setItem(SECOND_OPEN_KEY, Date.now());
          localStorage.setItem(LAST_OPEN_KEY, Date.now());
          timerId = null;
        }, 30 * 1000);
      }
    });

    // Popup réouverture toutes les 3 minutes après 2e ouverture
    if (secondOpen && (Date.now() - lastOpen >= 3 * 60 * 1000)) {
      showPopup();
      localStorage.setItem(LAST_OPEN_KEY, Date.now());
    }
  })();
